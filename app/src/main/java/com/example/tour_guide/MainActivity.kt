...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btntourguide = findViewById<Button>(R.id.btntourguide)

        btntourguide.setOnClickListener{
            Intent(this, TourGuideActivity::class.java).also {
                startActivity(it)
            }
        }

        val btndestinasi = findViewById<Button>(R.id.btndestinasi)

        btndestinasi.setOnClickListener{
            Intent(this, DestinasiActivity::class.java).also {
                startActivity(it)
            }
        }
